...
@section('seo_title')
    {{ $other_page_item->forget_password_page_title }}
@endsection
@section('seo_meta_description')
    {{ $other_page_item->forget_password_page_meta_description }}
@endsection
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                    <div class="login-form">
                        <form action="{{ route('candidate_forgot_password_submit') }}" method="post">
                            @csrf
                            <div class="mb-3">
